...
public class VipRoom {
    ...
    public boolean updateStatusToOccupied(String room,String Type){
        File file=new File("src/Hotel_Management_System/Room/RoomDetails/RoomTextFiles/VipRoom.txt");
        String[][]data;
    ...
    public void Admin_Frame(){
        JFrame fm = new JFrame("VIP Room Details");
        ...
        ImageIcon image1=new ImageIcon("src/img/VipRoom.jpg");
                ...
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (selectedRow >= 0) {
                        ...
                        if(response==JOptionPane.YES_OPTION){
                            if(type.equals("VIP/SINGLE")){
                                fm.dispose();
                                new GuestRegistration(roomNo,"VIP/SINGLE",6000.0);
                            }
                            else if(type.equals("VIP/DOUBLE")){
                                fm.dispose();
                                new GuestRegistration(roomNo,"VIP/DOUBLE",8000.0);
                            }
                        }
                    }
                }
